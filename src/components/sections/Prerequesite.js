            ...
            <div>
              ...
              <div className="text-primary-muted">
                <ul className="ml-6 mb-4">
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">1.</sapn> Go to
                    the link <a href="https://dashboard.onmeta.in" target="_blank" rel="noreferrer" className="font-bold cursor-pointer text-primary-accent">( prod / </a> <a href="https://stg.dashboard.onmeta.in" target="_blank" rel="noreferrer" className="font-bold cursor-pointer text-primary-accent">stag )</a> to register in our dashboard. Enter your email
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">2.</sapn> Enter
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">3.</sapn> Upon
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">4.</sapn> Register
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">5.</sapn> Home
                    Page
                    <div className="flex justify-center">
                      <img
                        src="/homePage.png"
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">6.</sapn> API Key
                    <div className="flex justify-center">
                      <img
                        src="/apiKey.png"
                        alt="OnMeta Complete Flow"
                  ...
                  <li className="mb-4">
                    <sapn className="text-primary-text font-bold">7.</sapn> Token
                    Selection 
                    <div className="flex justify-center">
                      <img
                        src="/token.png"
