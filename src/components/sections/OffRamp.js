    ...
    <div className="space-y-12">
      <div className="flex justify-between items-center">
        ...
        <div className="relative">
          ...
          <div
            className={`absolute right-0 top-full mt-2 bg-light-surface dark:bg-primary-surface border border-light-brdr dark:border-primary-brdr rounded-lg shadow-xl overflow-hidden transition-all duration-300 ease-out z-10 ${
              isToggleOpen
              ...
              <div className="space-y-3">
                <div className="group">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-semibold text-light-accent dark:text-primary-accent uppercase tracking-wide">
                      Production
                    </span>
                    <button
